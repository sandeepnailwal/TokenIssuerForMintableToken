...
function prepareContract (client){
    ...
    var contractAddress = "0x89d1df5747629c5fafc1819946b7548aa5b85cf3";
...
let getReferrerIndex = (address) =>  {
    ...
    return new Promise(function(resolve,reject)
    {
        contract.methods.getReferrerIndex(address).call(function (err,result) {
...
let referrerRewardsByIndex = (address,i) => {
    ...
    return new Promise(function(resolve,reject)
    {
        contract.methods.getReferrerRewards(address,i).call(function (err,result) {
...
module.exports = {getTransaction,referrerRewards,getBlockNumber,feedReferral,unlockDefaultAccount,getBalance,ethContributedBy,totalEthContributed1,totalTokensSold,getReferrerIndex,referrerRewardsByIndex};
